...
{
    /** Question bonus ici :
     *  combien de forces est calculées par la tâche 't' ?
     *
     * On numérote les tâches:
     *  't=0' itère pour 'i=0' à 'i=BODIES_PER_TASK' exclu
     *  't=1' itère pour 'i=BODIES_PER_TASK' à 'i=2xBODIES_PER_TASK' exclu
     * [...]
     */
