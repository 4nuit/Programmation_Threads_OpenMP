...
#include <stdlib.h>
#include <stdio.h>
// Added: _XOPEN_SOURCE must be defined to allow for ucontext since it is deprecated on macOS (something like 12 years old deprecation)
...
#define MTHREAD_LIST_INIT                  \
  {                                        \
    .first = NULL, .last = NULL, .lock = 0 \
  }
